...
var requirejs, require, define;//只是向外暴露了这三个变量
(function (global, setTimeout) {
    ...
    if (isBrowser && !cfg.skipDataMain) {
        ...
        eachReverse(scripts(), function (script) {
            ...
            // 查找data-main属性以设置页面的主脚本加载
            // 如果它存在，数据主路径就成为了baseUrl。data-main---->baseUrl
            dataMain = script.getAttribute('data-main');//data-main是js/entry
            if (dataMain) {
                ...
                if (!cfg.baseUrl && mainScript.indexOf('!') === -1) {
                    ...
                    //baseUrl.
                    src = mainScript.split('/');//src=['js','entry']
                    mainScript = src.pop();//src=['js'] mainScript='entry'
                    subPath = src.length ? src.join('/') + '/' : './';//subPath= js + '/'

                    cfg.baseUrl = subPath;//cfg={baseUrl : "js/"}
